...
const Footer = () => {
  ...
  return (
    <div className="hidden md:flex mt-16 flex-col items-center gap-8 md:flex-row md:items-start md:justify-between md:gap-0 bg-[rgb(var(--card))] p-8 rounded-lg">
      ...
      <div className="flex flex-col gap-4 items-center md:items-start">
        ...
        <p className="text-sm text-[rgb(var(--muted))]">© 2025 Befit.</p>
        <p className="text-sm text-[rgb(var(--muted))]">{t("footer.rights")}</p>
      </div>

      <div className="flex flex-col gap-4 text-sm text-[rgb(var(--muted))] items-center md:items-start">
        <p className="text-sm text-[rgb(var(--text))]">{t("footer.links")}</p>
